...
- A small, image-free “Not safe for work photos” card appears after the travel section. The NSFW navigation item prepares the remaining postcard rows before scrolling to it, so progressive loading cannot move the destination during the jump. Direct `#body-positive` links do the same; photographs remain lazy-loaded.
